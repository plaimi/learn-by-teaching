...
\item Errant learning has been thought to be detrimental to learning as people
  ...
  % TODO -- either 'benefitted' is misspelt, or we need a [sic]. Or,
  % alternatively, and what I would greatly prefer, we rewrite it using our
  % own wording. Quoting are 99% of the time just an indication that you don't 
...
% TODO summarise the experiments in ^, to save people the effort of looking
% them up.
